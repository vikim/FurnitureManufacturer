namespace FurnitureManufacturer.Engine.Factories
{
    ...
    public class FurnitureFactory : IFurnitureFactory
    {
        ...
        public IAdjustableChair CreateAdjustableChair(string model, string materialType, decimal price, decimal height, int numberOfLegs)
        {
            ...
            return new AdjustableChair(model, this.GetMaterialType(materialType).ToString(), price, height, numberOfLegs);
        }
        ...
        {
            // TODO: Implement this method
            return new ConvertibleChair(model, this.GetMaterialType(materialType).ToString(), price, height, numberOfLegs);
        }
